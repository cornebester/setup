# Setup script for Redash with Docker on MacOS.

This is a reference setup for Redash on macos, which uses Docker and Docker Compose for deployment and management.
